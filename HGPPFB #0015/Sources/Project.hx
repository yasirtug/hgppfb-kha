...
class Project{
	...
	public function new() {
		...
		for (i in 0...n){
			...
			new Vec2(200 + 50 * Maths.Cos(angle), 200 + 50 * Maths.Sin(angle) * r),
			r,
	...
	function update(): Void
	{
		...
		while(--i >= 0){
			trace(i);
			var o = bodies[i];
			var gap = Vec2.sub(o.center, new Vec2(200.0,200.0));
